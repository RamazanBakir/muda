...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Overlay
        ...
        className={cn(
            "fixed inset-0 z-50",
            "bg-[hsl(var(--neutral-12)/0.4)] backdrop-blur-sm",
    ...
    <DialogPortal>
        ...
        >
            ...
            <DialogPrimitive.Close className={cn(
                ...
                "hover:bg-[hsl(var(--neutral-2))] hover:text-[hsl(var(--neutral-9))]",
...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Description
        ref={ref}
        className={cn("text-sm text-[hsl(var(--neutral-7))] leading-relaxed", className)}
        {...props}
    />
))
